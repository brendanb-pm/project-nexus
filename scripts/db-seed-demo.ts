...
async function main() {
  ...
  try {
    ...
    await pool.query("INSERT INTO auth_users (id, name, email, email_verified) VALUES ('nexus-dev-auth-client-user-a', 'Client User A', 'client.a@nexus.demo.invalid', true); INSERT INTO users (id, organization_id, email, status) VALUES ('00000000-0000-4000-8000-000000000130', $1, 'client.a@nexus.demo.invalid', 'active'); INSERT INTO external_identities (issuer, subject, user_id) VALUES ('local-dev://nexus', 'client-user-a', '00000000-0000-4000-8000-000000000130'); INSERT INTO auth_accounts (id, issuer, account_id, provider_id, user_id) VALUES ('nexus-dev-account-client-user-a', 'local-dev://nexus', 'client-user-a', 'nexus-oidc', 'nexus-dev-auth-client-user-a'); INSERT INTO user_memberships (user_id, organization_id, status) VALUES ('00000000-0000-4000-8000-000000000130', $1, 'active'); INSERT INTO employees (id, organization_id, user_id, employee_number, employment_status, primary_branch_id, profile) VALUES ('00000000-0000-4000-8000-000000000131', $1, '00000000-0000-4000-8000-000000000130', 'CLIENT-100', 'active', $2, '{\"name\":\"Client User A\"}'::jsonb); INSERT INTO employee_roles (employee_id, role, client_id) VALUES ('00000000-0000-4000-8000-000000000131', 'CLIENT_USER', $3)", [ids.organization, ids.branch, ids.client]);
    await pool.query(
